#ifndef HS_IO_CTL_A_WS2_H
#define HS_IO_CTL_A_WS2_H
/*
...
#define HS_A_VIB_EN_ON() \
	gpio_direction_output( GPIO_VIB_EN, GPIO_HI )

#define HS_A_VIB_EN_OFF() \
	gpio_direction_output( GPIO_VIB_EN, GPIO_LO )
