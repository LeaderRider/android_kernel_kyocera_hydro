...
static unsigned char sd_insert_flag = SD_REMOVED;
...
#ifdef CONFIG_TARGET_PRODUCT_C5171
	/* MAIN_ANT_SW_AWS */
...
#else  /* CONFIG_TARGET_PRODUCT_C5171 */
	/* MAIN_ANT_SW_AWS */
	struct pm8xxx_gpio_init_info pm_gpio_main_ant_sw_aws = {
		GPIO_MAIN_ANT_SW_AWS,
		{
...
#endif /* CONFIG_TARGET_PRODUCT_C5171 */
...
static unsigned msm7x30_gpio_table[] = {
...
static int msm7x30_gpios_init(void)
{
	int pin, rc;

	if( HS_HW_ID <= HS_HW_ID_G39_WS1 )
	{
		for (pin = 0; pin < ARRAY_SIZE(msm7x30_gpio_table); pin++) {
			rc = gpio_tlmm_config(msm7x30_gpio_table[pin],
						GPIO_CFG_ENABLE);
			if (rc) {
				printk(KERN_ERR
					"%s: gpio_tlmm_config(%#x)=%d\n",
					__func__, msm7x30_gpio_table[pin], rc);
			}
		}
		return rc;
	}
...
#ifdef FEATURE_KYOCERA_MCAM
	GPIO_CFG(4,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D0       */
	GPIO_CFG(5,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D1       */
	GPIO_CFG(6,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D2       */
	GPIO_CFG(7,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D3       */
	GPIO_CFG(8,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D4       */
	GPIO_CFG(9,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D5       */
	GPIO_CFG(10, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D6       */
	GPIO_CFG(11, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D7       */
...
static uint32_t camera_on_gpio_table[] = {
	/* parallel CAMERA interfaces */
#ifdef FEATURE_KYOCERA_MCAM
	GPIO_CFG(4,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D0       */
	GPIO_CFG(5,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D1       */
	GPIO_CFG(6,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D2       */
	GPIO_CFG(7,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D3       */
	GPIO_CFG(8,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D4       */
	GPIO_CFG(9,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D5       */
	GPIO_CFG(10, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D6       */
	GPIO_CFG(11, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* D7       */
...
static uint32_t msm_sdcc_setup_gpio(int dev_id, unsigned int enable)
{
	...
	if (enable) {
		...
		if (curr->sleep_cfg_data) {
		    ...
		    if(dev_id == 4) {
		    	if(!gpio_get_value(GPIO_CARD_DETB) || (sd_insert_flag == SD_INSERTED)) {
		    		if (!sd_insert_flag) {
		    			sd_insert_flag = SD_INSERTED;
		    		}
					gpio_set_value(58, 0);
					gpio_set_value(59, 1);
					gpio_set_value(60, 1);
