...
#define MS3TEST_NO_ERROR            (0)
#define MS3TEST_ERR_I2C             (-1)
#define MS3TEST_ERR_BUSY            (-5)
#define MS3TEST_ERR_OVERFLOW        (-6)
#define MS3TEST_ERR_UNDERFLOW       (-7)
#define MS3TEST_ERR_HALT            (-8)
#define MS3TEST_ERR_ARG             (-128)

#define MS3C_BUSY_RETRY_NUM         (10)

#define MS3CDRV_WAIT_MEASURE_TESTCOIL    (10)
...
struct yas_fusion {
    ...
    int (*get_fusion)(struct yas_quaternion *quaternion, struct yas_vector *acc,
...
struct yas_utility {
    ...
    int (*get_euler)(struct yas_matrix *rotation_matrix, struct yas_vector *euler);
};
