...
static int yas_bma250_power_up(void)
{
    if (acc_data.chip_id == YAS_BMA250_CHIP_ID_250) {
        ...
        yas_bma250_update_bits(YAS_BMA250_POWERMODE_250, YAS_BMA250_POWERMODE_250_LOW);
    } else if (acc_data.chip_id == YAS_BMA250_CHIP_ID_250E) {
        yas_bma250_update_bits(YAS_BMA250_POWERMODE_250E, YAS_BMA250_POWERMODE_250E_NORMAL);
        yas_bma250_update_bits(YAS_BMA250_DATA_ENBL, 1);
    }
...
static int yas_bma250_power_down(void)
{
    if (acc_data.chip_id == YAS_BMA250_CHIP_ID_250) {
        ...
        yas_bma250_update_bits(YAS_BMA250_POWERMODE_250, YAS_BMA250_POWERMODE_250_SUS);
    } else if (acc_data.chip_id == YAS_BMA250_CHIP_ID_250E) {
        yas_bma250_update_bits(YAS_BMA250_POWERMODE_250E, YAS_BMA250_POWERMODE_250E_DSUS);
    }

    return YAS_NO_ERROR;
}

/* recovery from the damage of mtp. >>> */
static int yas_bma250_mtp_recovery(void)
{
  struct yas_acc_driver_callback *cbk = &pcb->callback;
...
/* recovery from the damage of mtp. <<< */
    ...
    if (!((id == YAS_BMA250_CHIP_ID_250) || (id == YAS_BMA250_CHIP_ID_250E))) {
