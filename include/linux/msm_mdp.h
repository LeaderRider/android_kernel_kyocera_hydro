...
#define MSMFB_FREX_CHECK     _IOW(MSMFB_IOCTL_MAGIC, 200, unsigned int)
#define MSMFB_LCD_BACKLIGHT  _IOW(MSMFB_IOCTL_MAGIC, 201, unsigned int)
#define MSMFB_LCD_STATUS_GET _IOW(MSMFB_IOCTL_MAGIC, 202, unsigned int)
#define MSMFB_LCD_BACKLIGHT_OFF _IOW(MSMFB_IOCTL_MAGIC, 203, unsigned int)
